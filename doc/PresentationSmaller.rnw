...
\begin{description} 
\item [Other] Reduction, food and bait, special use
\item [Roe seine] Roe seine
\item [Roe gillnet] Roe gillnet
\end{description}
\begin{itemize}
