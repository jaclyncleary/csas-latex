...
% New slide
\begin{frame}
Corrected estimation of the variance structure based on reviewer comments on 2011 herring stock assessment (DFO 2012)
...
We recommend defining two Base cases for each of the 5 major herring stocks: AM1
and AM2, and we recommend using the new ISCAM platform (V2) with the same assumptions and parameter
settings as were used in 2016.
