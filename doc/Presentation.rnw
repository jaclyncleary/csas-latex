...
\institute{Regional Peer Review Process\\Pacific Region\\CSAP Working paper 2017PEL01}
...
\item Combination of low production and low biomass (LP-LB) state
\end{itemize}
\end{frame}
