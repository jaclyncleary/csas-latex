...
% New slide
\begin{frame}
We corrected the estimation of the variance structure based on reviewer comments on 2011 herring stock assessment \citep{herring2012}
\begin{itemize}
...
% New slide
\begin{frame}
Tables D1 and D2: Comparisons of MPD estimates of leading parameters and unfished biomass, $\mli{SB}_0$, given changes to the estimation of the variance structure for process and observation error (AM1 and AM2)
\end{frame}
