...
\footnote{http://www.dfo-mpo.gc.ca/reports-rapports/regs/sff-cpd/precaution-eng.htm}
\begin{itemize}
\item Reference points should be established using as long as a time series as possible
