...
\begin{frame}{Terms of Reference}
\begin{enumerate}
\item (b) Present herring spawn-on-kelp (SOK) fishery data and methods for including SOK data as input data for each stock area.
\end{enumerate}
\begin{itemize}
...
% % New slide ADD IN EXAMPLE Seine BUBBLE PLOTS FOR COMPARISON
% \begin{frame}
% \centering
% \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{maindoc/figures/SOGbubbleplots.png}
% \end{frame}
...
\begin{column}{0.5\textwidth}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{maindoc/figures/HGAM1.png}
\end{column}
\begin{column}{0.5\textwidth}
\centering
\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{maindoc/figures/Figure31HGAM2.png}
\end{column}
\end{columns}
\end{frame}
