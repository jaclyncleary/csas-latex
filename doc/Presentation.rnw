...
% New slide
\begin{frame}
Figure 102. Estimated proportion-at-age versus time for Gear 2 (roe seine), for Haida Gwaii.
...
% New slide
\begin{frame}
Figure 111. Estimated proportion-at-age versus time for Gear 2 (roe seine), for the Strait of Georgia.
The area of each circle reflects the proportion-at-age, each column sums to 1, zeros are not shown.
Plus group is age-10.
