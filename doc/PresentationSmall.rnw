% Document class
\documentclass[aspectratio=149, xcolor=table]{beamer}  % 169, 1610, 149, 54, 43, or 32
...
\subsection{Projected pre-fishery spawning biomass in \Sexpr{nextYr}}
...
\subsection{Reference points: LRP and USR}
