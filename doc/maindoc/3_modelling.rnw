...
Prior probability distributions for leading parameters for each major stock are shown in Tables \ref{tab:parameters} \& \ref{tab:q-params}, and Figures \ref{fig:hg-priors} to \ref{fig:wcvi-priors}.
