...
AM2 estimates the median spawning biomass in 2017 ($\mli{SSB}_{2017}$) at 3,963 t and 17\% of $\mli{SB}_0$. 
AM1 estimates the median spawning biomass in 2017 ($\mli{SSB}_{2017}$) at 7,336 t and 25\% of $\mli{SB}_0$.
Both AM2 and AM1 models estimate $\mli{SSB}_{2017}$ to be below the LRP of $0.30\cdot\mli{SB}_0$ (Figure \ref{figCurrentSSB}).
The pattern of biomass estimates for AM2 is similar to that of AM1, however AM2 estimates of $\mli{SSB}_{2017}$ and stock status relative to $\mli{SB}_0$ are lower than the AM1 estimates, due largely to differences in model estimates of $q_2$ (Table \ref{tab:q-parameters}).
...
AM2 estimates the median spawning biomass in 2017 ($\mli{SSB}_{2017}$) at 30,474 t and 55\% of $\mli{SB}_0$. 
AM1 estimates the median spawning biomass in 2017 ($\mli{SSB}_{2017}$) at 49,620 t and 80\% of $\mli{SB}_0$.
Based on a comparison of median estimates, both AM2 and AM1 models estimate $\mli{SSB}_{2017}$ to be above the LRP of $0.30\cdot\mli{SB}_0$ by greater than 50\% probability (Figure \ref{figCurrentSSB}).
The pattern of biomass estimates for AM2 is similar to that of AM1, however AM2 estimates of $\mli{SSB}_{2017}$ and stock status relative to $\mli{SB}_0$ are lower than the AM1 estimates, due largely to differences in model estimates of $q_2$ (Table \ref{tab:q-parameters}).
...
The projected pre-fishery spawing biomass in 2018 is 30,078 t (AM2) or 47,900 t (AM1), consisting of XX\% (median) age-3 fish and XX\% (median) age-4 and older fish (Table \ref{tab:cc-ref-points} and XX).  
%JC: edits completed
