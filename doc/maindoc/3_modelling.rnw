...
Model inputs of asymptotic growth (L_infinity=27), alpha and beta for the length-weight allometry (alpha=4.5e-06, beta=3.127), and Brody growth coefficient (k=0.48) were taken from FishBase (\citep{XX}). 
Age at 50\% maturity was estimated at 2.055.
