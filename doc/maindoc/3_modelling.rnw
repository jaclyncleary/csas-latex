...
Ageing errors are currently analyzed and corrected for outside the assessment model.
Typically, about 10\% of herring samples are independently aged by two technicians.
If there is disagreement between technicians, additional samples are aged by two technicians until agreement is reached.
