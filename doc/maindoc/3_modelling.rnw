...
Ageing errors are currently analyzed and corrected outside the assessment model.
Typically, about 10\% of herring otoliths are independently aged by two technicians to determine sample precision.
If technicians disagree on an given age, they independently review the otoligh until either they resolve the disagreement, or they are unable to resolve the disagreement.
Otoliths with unresolved age often have an unclear or confusing patterns that prevent definitive interpretation.
If sample precision is less than 80\%, more otoliths are double-checked to ensure that the sample is not biased.
