...
The ISCAM modelling code used in \Sexpr{assess.yr} has been updated to the new platform, the details of which are described in the Bridging Analysis (Appendix \ref{chap:bridge}).
...
The hybrid constant escapement/instant harvest rate feature of the herring HCR was intended to maintain a minimum escapement level equal to the commercial fishery cut-off.
