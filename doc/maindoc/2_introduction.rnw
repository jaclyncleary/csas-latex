...
The USR and TRP can equivalent, and the TRP cannot be lower than the USR and may be higher.
The USR is to be developed by fishery managers informed by consultations with the fishery and other interests, with advice and input from Science. Although socio-economic factors may influence the location of the USR, these factors must not diminish its role in guiding management of the risk of approaching the LRP.
