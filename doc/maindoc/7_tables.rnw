...
<<q.parameters.table, results='asis', echo=FALSE>>=
cap <- paste0("Estimated catchability (q) parameters and ",
              "prior probablilty distributions used in all SAR models.")
make.catchability.parameters.table(sens.models.1,
                                   base.models,
                                   xcaption = cap,
                                   xlabel = "tab:q-parameters",
                                   font.size = 10,
                                   space.size = 11,
                                   placement = "H")
@
...
cap <- paste0("Maturity vectors used in the sensitivity cases.")
