...
Projected pre-harvest spawning biomass estimates (i.e., prior to any harvest in \Sexpr{max(yrRange)+1}), and the relative contribution of fish of age-3 and ages 4-10 are presented in Table XX.
