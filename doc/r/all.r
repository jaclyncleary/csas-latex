...
source(file.path(iscam.gui.dir, "iscam-gui-figures-mle-diagnostics.r"))
source(file.path(iscam.gui.dir, "iscam-gui-figures-retrospectives.r"))
source(file.path(iscam.gui.dir, "iscam-gui-figures-sar.r"))
source(file.path(iscam.gui.dir, "iscam-gui-figures-selex.r"))
source(file.path(iscam.gui.dir, "iscam-gui-figures-timeseries.r"))
source(file.path(iscam.gui.dir, "iscam-gui-file-control.r"))
source(file.path(iscam.gui.dir, "iscam-gui-globals.r"))
source(file.path(iscam.gui.dir, "iscam-gui-load-biodata.r"))
source(file.path(iscam.gui.dir, "iscam-gui-load-catchdata.r"))
source(file.path(iscam.gui.dir, "iscam-gui-tables.r"))
