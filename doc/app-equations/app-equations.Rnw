...
\chapter*{APPENDIX~\thechapter. MODEL DESCRIPTION AND EQUATIONS}
\rfoot{Appendix~\thechapter~-- Model Description and Equations}
\addcontentsline{toc}{chapter}{APPENDIX~\thechapter. MODEL DESCRIPTION AND EQUATIONS}
