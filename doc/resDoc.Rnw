...
\newcommand{\mcmclength}{15 million} % MCMC Chain length
\newcommand{\mcmcsampfreq}{7,500}    % Sampling frequency
...
\renewcommand{\bibsection}{\section{\bibname}}  % To make it a section and
                                                %  then number it
...
%%<<echo=TRUE,  message=TRUE, results='asis', warning=TRUE>>=
...
## opts_chunk$set(dev='cairo_ps',fig.path='knitr-cache/', fig.dpi=96, fig.width=7.5,
##                fig.height=4, echo=TRUE, results='asis', message=TRUE, warning=TRUE, error=FALSE,
##                cache=TRUE, cache.path='knitr-cache/')
...
\setcounter{chapter}{0}    % Need this for first Appendix heading
...
%\setcounter{chapter}{1}    % Need this for first Appendix heading
...
% Now want section headings left-justified not centered; this
%  is same as in resDocSty.sty but without \centering
\makeatletter
...
% Need these for the appendix numbering.
%\addtocounter{chapter}{1}     % Not needed for first appendix.
%% \setcounter{section}{0}
%% \setcounter{table}{0}
%% \setcounter{figure}{0}
%% \setcounter{equation}{0}

%% RSIA no longer to be included in the document
...
\refstepcounter{chapter}
%\setcounter{chapter}{2}    % Need this for first Appendix heading
%\rfoot{Appendix B -- Proportion Female Analysis}
<<prop-female, child='app-propfemale/app-propfemale.Rnw'>>=
@

\refstepcounter{chapter}
%\setcounter{chapter}{3}    % Need this for first Appendix heading
%\rfoot{Appendix C -- Age Composition weighting}
<<agecomp-weighting, child='app-agecompweighting/app-agecompweighting.Rnw'>>=
@

\refstepcounter{chapter}
%\setcounter{chapter}{4}    % Need this for first Appendix heading
