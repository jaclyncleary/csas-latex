...
\includegraphics[scale=1.0]{title-header.png}
...
\textsuperscript{1}
Pacific Biological Station, Science Branch,\\
...
\vspace{-3.5mm}
\parbox{5cm}{Release date (Month Year)}%
\hfill
\includegraphics[scale=0.85]{title-footer.png}
